...
const Blogs = () => {
 ...
 <section>
      <div  className='text-center font-semibold  my-14'>
        <p className='bg-[#EDF3FF] w-fit m-auto font-semibold text-[#3675ff] px-5 py-2 rounded-full'>Blogs</p>
    ...
    <div className='h-[110vh] relative font-semibold rounded-3xl overflow-hidden'>
      <img className='h-full w-full absolute  z-0 object-cover' src='https://framerusercontent.com/images/gdYugKRVEppOdaBaZCcPZkB1pM.jpg'/>
      <div className='absolute z-10 bottom-10 left-5 sm:left-10 rounded-2xl sm:p-8 p-2 bg-white/30 backdrop-blur-sm  '>
      <p className='text-[#EDF3FF] w-fit  bg-[#3675ff] px-3 py-2 rounded-full'>Resources</p>
