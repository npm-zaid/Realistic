...
function Navbar() {
  ...
  return (
    <>
  <nav className={`fixed z-50 top-0 left-0 ease-in-out lg:backdrop-blur-sm w-full px-[5vw] py-5 flex justify-between items-center transition-all duration-500  ${showNavbar ? 'translate-y-[-100%] ' : 'translate-y-0'}`}>
<h1 className='font-semibold sm:text-[2vw] text-[7vw]'><NavLink to='/'>Realestic</NavLink></h1>
